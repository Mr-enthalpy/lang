...
pub enum ConstructorHead {
    ...
    Owner { owner_head: PatternHeadId },
...
impl ConstructedValue {
    ...
    pub fn constructor_head(&self) -> Option<ConstructorHead> {
        match self {
            ConstructedValue::Owner { owner_head, .. } => Some(ConstructorHead::Owner {
    ...
    pub fn semantic_eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            ) => o1 == o2 && fh1 == fh2 && f1 == f2 && t1 == t2 && pr1 == pr2 && p1.semantic_eq(p2),
            (
...
pub fn placeholder_owner_constructor_head(owner_head: PatternHeadId) -> ConstructorHead {
