...
pub use policy_pair::{
    ...
    publicly_reachable, BuiltinPrivilegedSealFunction, ExportCandidateProjection,
    ExportCandidateView, FormalPolicyPattern, FunctionMember, FunctionMemberKind, FunctionObject,
