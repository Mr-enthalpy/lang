...
//! complete type result attaches to the ambient declaration environment, and at
...
fn struct_result_root(
    ...
    let type_value = world
        ...
        .expect("struct result Pattern pairs with a Core lookup index");
    (pattern, type_value)
}
...
fn different_function_self_owners_do_not_share_an_ambient_struct_root() {
    ...
    let (pattern_f, type_f) = struct_result_root(&world, &under_f);
    let (pattern_g, type_g) = struct_result_root(&world, &under_g);
    assert_eq!(
