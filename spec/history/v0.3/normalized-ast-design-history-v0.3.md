# v0.3 Normalized AST — Design History and Audit Trail

This is the historical record of the Normalized AST design questions
(`N-AST-1..9`), their resolutions, the N-AST-9 review audit trail, and the
documentation-reset debt log. They arose during v0.3 Normalized AST
Specification and were resolved by the published v0.5 public docs.

This directory is historical. Current normalized surface behavior is defined by
`spec/public/v0.5/normalized-surface-semantics-v0.5.md`. The entries below are
retained only as the resolution / audit trail.

The v0.3 baseline specification referenced below is
[`normalized-ast-specification-v0.3.md`](normalized-ast-specification-v0.3.md)
in this directory.

---

## N-AST design questions (resolved)
...
`normalized-ast-specification-v0.3.md` §7, and the minimum node
...
**Resolution (v0.3):** Yes. `normalized-ast-specification-v0.3.md`
...
`normalized-ast-specification-v0.3.md` §8.7. Future phases may
...
**Resolution (v0.3):** See
`normalized-ast-specification-v0.3.md` §8.2–§8.5. The direction
is:
...
See `normalized-ast-specification-v0.3.md` §7.13. Alias target
...
### N-AST-9. Member / double-dot sugar lowering proposal — review concerns
...
into `normalized-ast-specification-v0.3.md` §7.11 (member,
...
## Documentation reset debt (audit)
