...
Name resolution produces one terminal Symbol before any value, type, call, or
Pattern projection. Explicit navigation therefore resolves a stable host chain
and terminal Symbol once. Callability, applicability, and extraction failure do
not restart lexical resolution at an outer same-name Symbol.
