...
| Current atomic literal and cross-Policy value-transition vertical slice | `../contracts/v0.6-cross-policy-value-transition.md` | Canonical Policy algebra remains in the symbol-world owner; runtime/global/lifetime completion remains deferred |
