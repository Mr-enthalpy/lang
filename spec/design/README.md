...
| Current T/Tnum helper and cross-Policy candidate-ordering prototype | `../contracts/v0.6-cross-policy-value-transition.md` | Canonical P1 remains projection in the symbol-world owner; initializer and global function-object routing remain deferred |
