...
| Canonical `Pv:Pp`, orthogonal whole-slot `PolicyMode`, contextual binding `P1`, result `P2`, function-object stage derivation, seal visibility/snapshot, three-point preference, 3×3 capability realization, external eligibility, no scalar result policy, mechanical compile projection, companions, match staging, and coarse automatic require | `symbol-world/symbol-policy-and-compile-flow-projection.md` | Implementation mapping, invocation handoff, pattern algebra, and links |
