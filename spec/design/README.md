...
| Generic PolicyDemand frontier, P1 conservative-extension corollary, and Runtime Val1/Pattern-policy decomposition | `symbol-world/symbol-policy-and-compile-flow-projection.md` | Current BindingP1 helper coverage stays in the v0.6 transition contract |
