...
| Transition endpoint Policy preference placement in the overload pipeline | `patterns-overload/overload-resolution-design.md` | Final Bp' is one product over ordinary and endpoint coordinates; current endpoint-only maxima is a private fixture, not a composable Bp filter |
