...
| P1 conservative extension law and Runtime Val1/Pattern-policy decomposition | `symbol-world/symbol-policy-and-compile-flow-projection.md` | Current helper coverage stays in the v0.6 transition contract |
| Transition as compiler-inserted ordinary function-object invocation | `symbol-world/function-object-call-model.md` | Current caller-supplied callable carrier is not the final route |
| Transition Policy preference placement in the overload pipeline | `patterns-overload/overload-resolution-design.md` | Input × output Policy is the transition-specific B6 named strategy |
| Literal family, atomic builtin family T, and concrete numeric Tnum identity | `symbol-world/type-values-places-and-alias-forwarding.md` | Current helper/core coverage stays in the v0.6 transition contract |
