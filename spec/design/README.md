...
| Current T/Tnum literal and cross-Policy value-demand decomposition slice | `../contracts/v0.6-cross-policy-value-transition.md` | Canonical Policy algebra remains in the symbol-world owner; global function-object routing and runtime/global/lifetime completion remain deferred |
