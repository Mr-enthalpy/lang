...
symbol's Pattern layer supplies its static pattern space directly; that space
may be extracted; extraction produces both residual input space and completed
...
from these rules rather than from a separate built-in `match` checker.
