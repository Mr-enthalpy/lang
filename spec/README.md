...
| `contracts/v0.6-cross-policy-value-transition.md` | Normative for the bounded implementation prototype | Records the T/Tnum helper, projection-empty transition-preparation boundary, absent-Val1 exclusion, Runtime Val1 validator, and transitional input × output Policy candidate ordering without redefining canonical ordinary P1. |
...
| `v0.6-cross-policy-value-transition.md` | Normative for the bounded implementation prototype | Records helper/candidate-algebra guarantees and explicit non-integration boundaries; it defers to the canonical policy and invocation owners for language semantics. |
