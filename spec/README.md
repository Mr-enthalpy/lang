...
| `entity-alias-design.md`           | Non-normative future design note                      | Documents future lexical alias binding syntax (`let binder === EntityRef`), scope rule, distinction from ordinary `let`, operator-alias restriction, future diagnostics sketch, and parser/semantic boundary. Not a v0.1 parser rule. |
