...
| Contract / handoff | `spec/contracts/` | `v0.6-cross-policy-value-transition.md` | Implementation boundary for the T/Tnum helper and conservative cross-Policy result/named-strategy prototype; canonical policy, invocation, type-value, and overload owners define the language direction |
