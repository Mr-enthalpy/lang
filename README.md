...
| Contract / handoff | `spec/contracts/` | `v0.6-cross-policy-value-transition.md` | Current T/Tnum literal, multi-entry P1 demand-decomposition, and transitional Policy-ordering contract |
