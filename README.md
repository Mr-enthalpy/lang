...
| Contract / handoff | `spec/contracts/` | `v0.6-cross-policy-value-transition.md` | Implementation boundary for the T/Tnum helper and transitional cross-Policy candidate-ordering prototype; canonical ordinary P1 semantics remain unchanged |
