...
| Contract / handoff | `spec/contracts/` | `v0.6-cross-policy-value-transition.md` | Current atomic literal and cross-Policy value-transition vertical-slice contract |
